import { useCartFactory, useCategoryFactory, useFacetFactory, useProductFactory, useReviewFactory, useUserFactory, useUserBillingFactory, useUserOrdersFactory, useUserShippingFactory, useWishlistFactory, integrationPluginFactory } from '@vue-storefront/core';
...
var index = useCartFactory(params);
...
var index$1 = useCategoryFactory(params$1);
...
var paymentMethods = ref(PAYMENT_METHODS_MOCK);
var shippingMethods = ref([]);
var personalDetails = ref({});
var shippingDetails = ref({});
var billingDetails = ref({});
var chosenPaymentMethod = ref('');
var chosenShippingMethod = ref({});
...
var useCheckout = function () {
    return {
        ...
        loading: computed(function () { return false; })
    };
};
...
var index$2 = useFacetFactory(factoryParams);
...
var index$3 = useProductFactory(params$2);
...
var index$4 = useReviewFactory(params$3);
...
var index$5 = useUserFactory(params$4);
...
var index$6 = useUserBillingFactory(params$5);
...
var index$7 = useUserOrdersFactory(params$6);
...
var index$8 = useUserShippingFactory(params$7);

var wishlist = ref(null);
var params$8 = {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    load: function (context) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
var index$9 = useWishlistFactory(params$8);
...
/* istanbul ignore file */
var integrationPlugin = integrationPluginFactory(createApiClient);

export { cartGetters, categoryGetters, checkoutGetters, facetGetters, integrationPlugin, orderGetters, productGetters, reviewGetters, index as useCart, index$1 as useCategory, useCheckout, useContent, index$2 as useFacet, index$3 as useProduct, index$4 as useReview, index$5 as useUser, index$6 as useUserBilling, index$7 as useUserOrders, index$8 as useUserShipping, index$9 as useWishlist, userGetters$2 as userBillingGetters, userGetters, userGetters$1 as userShippingGetters, wishlistGetters };
