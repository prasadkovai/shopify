...
var createApiClient = apiClientFactory({
    tag: 'shopify',
    onSetup: onSetup,
    api: {
...
export { AddressFragment, AttributeType, CartFragment, CustomerFragment, LineItemFragment, OrderFragment, ProductPriceFragment, ShippingMethodFragment, createApiClient, getCustomQuery };
